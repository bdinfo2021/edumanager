                        ...
                        <div class="form-container col-12 col-lg-12">
                            <form action="{{route('/customer-sign-in')}}" class="login-form" method="POST">
                                ...
                                <div class="form-group email">
                                    ...
                                    <input id="login-email" type="email" name="email" class="form-control login-email"
                                ...
                                <p class="lead">Don't have a Aamra account yet? <br/><a class="signup-link"
                                                                                        href="{{route('/customer-sign-up')}}">Create
