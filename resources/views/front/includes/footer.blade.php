                ...
                <div class="footer-col connect col-12 col-lg-6">
                    <div class="footer-col-inner">
                        ...
                        <div class="form-container">
                            <p class="intro">Stay up to date with the latest news and offers from Aamra</p>
                        ...
                        <p class="adr clearfix">
                            <i class="fa fa-map-marker pull-left"></i>
                                <span class="adr-group pull-left">
                                    <span class="street-address">Aamra Infotainment Limited</span><br>
                                    <span class="region">Safura Tower (16th Floor)</span><br>
                                    <span class="postal-code">20 Kemal Ataturk Avenue Banani</span><br>
                                    <span class="country-name">Dhaka-1213, Bangladesh</span>
                                </span>
                        </p>
                        <p class="tel"><i class="fa fa-phone"></i>+88 01712 126874 or +88 01913 397419 </p>
                        <p class="email"><i class="fa fa-envelope-o"></i><a href="#">sales.infotainment@aamra.com.bd</a></p>
                        <a href="https://twitter.com/aamracompanies" class="twitter-follow-button" data-show-count="false">Follow @aamracompanies</a>
    ...
    <div class="bottom-bar">
        <div class="container">
            <small class="copyright">
                    Powered by
                    <img src="{{asset('/')}}front/images/footer/poweredby-aamra-white.png" style="vertical-align:middle; float:none !important; margin-right:1px;">
                    |
                    <a href="http://www.aamrainfotainment.com" target="_blank"> infotainment ltd.</a>
            </small>
        </div><!--//container-->
    </div><!--//bottom-bar-->
</footer><!--//footer-->
